package com.photo.blender.blendphoto.mixphotos.doubleexposure.code.tools;
...
public class ImageUtils {
    ...
    public static void resampleImageAndSaveToNewLocation(String filepath, String new_loc, int widthPixels) {
