...
public class GalleryAdapter extends Adapter<GalleryAdapter.ViewHolder> implements OnClickListener {
    ...
    public GalleryAdapter(String[] listItem, Context ct,int selectedPosition) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        viewHolder.imageView.setBackgroundResource(R.drawable.bg_frame1);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putInt("selected_position1", selectedPosition);
                editor.apply();
            }
        });
    }
