...
public class LoadBackgroundActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(LoadBackgroundActivity.this.getApplicationContext(), "android.permission.READ_EXTERNAL_STORAGE") != 0
                || ContextCompat.checkSelfPermission(LoadBackgroundActivity.this.getApplicationContext(), "android.permission.WRITE_EXTERNAL_STORAGE") != 0) {
            if (Build.VERSION.SDK_INT >= 23) {
                LoadBackgroundActivity.this.requestPermissions(new String[]{"android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE"}, 922);
            }
        }
        ...
        tv_toolbar.setText(getText(R.string.select_bg));
        ...
        tv3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tv4.setBackgroundResource(R.drawable.bg_folder);
                myCreationAdapter = new MyCreationAdapter(LoadBackgroundActivity.this, getAllScreenshots1(), new MyCreationAdapter.OnClickImage() {
                    @Override
                    public void onClickImage(int pos) {
                       if (!isselected3){
                           Intent intent = new Intent(LoadBackgroundActivity.this, CropBackgroundActivity.class);
        ...
        tv4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myCreationAdapter = new MyCreationAdapter(LoadBackgroundActivity.this, getAllCamera(), new MyCreationAdapter.OnClickImage() {
                    @Override
                    public void onClickImage(int pos) {
    ...
    private ArrayList<Uri> getAllScreenshots() {
        ArrayList<Uri> screenshotList = new ArrayList<>();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            String[] selectionArgs = {Environment.DIRECTORY_DCIM + "/Screenshots"};
            String sortOrder = MediaStore.Images.Media.DATE_TAKEN + " DESC";

            try (Cursor cursor = resolver.query(screenshotUri, projection, selection, selectionArgs, sortOrder)) {
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        int columnIndex = cursor.getColumnIndexOrThrow(MediaStore.Images.Media._ID);
                        long id = cursor.getLong(columnIndex);
                        Uri contentUri = ContentUris.withAppendedId(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, id);
                        screenshotList.add(contentUri);
                        Log.e("loadScreen", "MediaStore");
                    }
                }
            }
        } else {
            ...
            if (screenshotsDirectory.exists()) {
                ...
                if (files != null) {
                    for (File file : files) {
                        screenshotList.add(Uri.fromFile(file));
                        Log.e("loadScreen", "Pic");
                    }
                }
            }
        }
